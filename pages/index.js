      ...
      <div className={styles.AppWrapper}>
        ...
        <div className={styles.team} ref={props.teamRef} id='team'>
          ...
          <div className={styles.teamWrapper}>
            <MemCard image={'/media/photo/elena.jpg'} animation={textAnimation} about={'Основатель компании'} name={'Елена Григорян'} custom={3} aboutText={'"Мы современная компания, создающая тренды и нацеленная на результат. Мы дружная, сплоченная команда единомышленников, влюбленных в свое дело! Наша цель - развитие и рост."'} />
